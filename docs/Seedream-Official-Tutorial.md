...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="V2nUgyi6nL"><RenderMd content={`\`\`\`Plain
...
<Tabs.TabPane title="Python" key="bY5vurRBRv"><RenderMd content={`\`\`\`Python
import os
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="MRNe8nhuGN"><RenderMd content={`\`\`\`Java
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="fnt8eNPFJn"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="OpenAI" key="lFjFYqqjXP"><RenderMd content={`\`\`\`Python
import os
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="XtgxF5EIIX"><RenderMd content={`\`\`\`Plain
curl https://ark.cn-beijing.volces.com/api/v3/images/generations \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $ARK_API_KEY" \\
  -d '{
...
* 您可按需替换 Model ID。Model ID 查询见 [模型列表](/docs/82379/1330310)。
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Python" key="XMHRxidgWO"><RenderMd content={`\`\`\`Python
import os
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="zfC16Ic4P0"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="QuRuBuC7aH"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="OpenAI" key="JaUwpbXAM4"><RenderMd content={`\`\`\`Python
import os
from openai import OpenAI
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="oLU75oZdGj"><RenderMd content={`\`\`\`Plain
curl https://ark.cn-beijing.volces.com/api/v3/images/generations \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $ARK_API_KEY" \\
  -d '{
...
* 您可按需替换 Model ID。Model ID 查询见 [模型列表](/docs/82379/1330310)。
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Python" key="s8xbgWLc41"><RenderMd content={`\`\`\`Python
import os
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="yNgTCJ3oWS"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="gYIDDN3605"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="OpenAI" key="ax2ai28ECV"><RenderMd content={`\`\`\`Python
import os
from openai import OpenAI
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="kCNeY0wiwo"><RenderMd content={`\`\`\`Plain
curl https://ark.cn-beijing.volces.com/api/v3/images/generations \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $ARK_API_KEY" \\
  -d '{
...
* 您可按需替换 Model ID。Model ID 查询见 [模型列表](/docs/82379/1330310)。
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Python" key="DoRc7l8icg"><RenderMd content={`\`\`\`Python
import os
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="hJ0DmwWtqt"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="JRMbBWk6X7"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="OpenAI" key="pOMBsNkMlf"><RenderMd content={`\`\`\`Python
import os
from openai import OpenAI
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="tUjakEmgNG"><RenderMd content={`\`\`\`Plain
curl https://ark.cn-beijing.volces.com/api/v3/images/generations \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $ARK_API_KEY" \\
  -d '{
...
* 您可按需替换 Model ID。Model ID 查询见 [模型列表](/docs/82379/1330310)。
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Python" key="H1mNA4huZD"><RenderMd content={`\`\`\`Python
import os
# Install SDK:  pip install 'volcengine-python-sdk[ark]' .
from volcenginesdkarkruntime import Ark
from volcenginesdkarkruntime.types.images.images import SequentialImageGenerationOptions
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="x2QvY0luNv"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="uyVvyoLscf"><RenderMd content={`\`\`\`Go
package main
...
* 您可按需替换 Model ID。Model ID 查询见 [模型列表](/docs/82379/1330310)。
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="OpenAI" key="T6BQbMXE4S"><RenderMd content={`\`\`\`Python
import os
from openai import OpenAI
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="bjILWbOyTA"><RenderMd content={`\`\`\`Plain
curl https://ark.cn-beijing.volces.com/api/v3/images/generations \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $ARK_API_KEY" \\
  -d '{
...
* 您可按需替换 Model ID。Model ID 查询见 [模型列表](/docs/82379/1330310)。
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Python" key="o3oOctGxEr"><RenderMd content={`\`\`\`Python
import os
# Install SDK:  pip install 'volcengine-python-sdk[ark]' .
from volcenginesdkarkruntime import Ark
from volcenginesdkarkruntime.types.images.images import SequentialImageGenerationOptions
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="HwHjJCHUKw"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="dbfo17DRo8"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="OpenAI" key="X9lYmxfkAk"><RenderMd content={`\`\`\`Python
import os
from openai import OpenAI
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="vN02yFbS9X"><RenderMd content={`\`\`\`Plain
curl https://ark.cn-beijing.volces.com/api/v3/images/generations \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $ARK_API_KEY" \\
  -d '{
...
* 您可按需替换 Model ID。Model ID 查询见 [模型列表](/docs/82379/1330310)。
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Python" key="v1AfT2mH25"><RenderMd content={`\`\`\`Python
import os
# Install SDK:  pip install 'volcengine-python-sdk[ark]' .
from volcenginesdkarkruntime import Ark
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="SdFfMtxoUB"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="CMTntpkzQ0"><RenderMd content={`\`\`\`Go
package main
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="UaDBf1Yj3T"><RenderMd content={`\`\`\`Plain
curl https://ark.cn-beijing.volces.com/api/v3/images/generations \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $ARK_API_KEY" \\
  -d '{
...
* 您可按需替换 Model ID。Model ID 查询见 [模型列表](/docs/82379/1330310)。
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Python" key="eChyvdMJ2v"><RenderMd content={`\`\`\`Python
import os
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark
from volcenginesdkarkruntime.types.images.images import SequentialImageGenerationOptions
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="HzX0VkexfO"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="jEdNIzpkTI"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="OpenAI" key="OZrtKjRT5c"><RenderMd content={`\`\`\`Python
import os
from openai import OpenAI
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="YVUxoSnXI1"><RenderMd content={`\`\`\`Plain
curl https://ark.cn-beijing.volces.com/api/v3/images/generations \\
  -H "Content-Type: application/json" \\
  -H "Authorization: Bearer $ARK_API_KEY" \\
  -d '{
...
* 您可按需替换 Model ID。Model ID 查询见 [模型列表](/docs/82379/1330310)。
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Python" key="fwbKczZ1y1"><RenderMd content={`\`\`\`Python
import os
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark
from volcenginesdkarkruntime.types.images.images import SequentialImageGenerationOptions
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="cngBp56jc2"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="Fi86FmuOYC"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="OpenAI" key="NPetH4gIhd"><RenderMd content={`\`\`\`Python
import os
from openai import OpenAI
