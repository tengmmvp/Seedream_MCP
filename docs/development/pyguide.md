...
starts with "Return", "Returns", "Yield", or "Yields" (e.g. `"""Returns row
    from Bigtable as a tuple of strings."""`) _and_ the opening sentence is
...
- New _unit test_ files follow PEP 8 compliant lower*with_under method
  names, for example, `test*<method*under_test>*<state>`. For consistency(\*)
