...
<table align="center">
  <tr>
    ...
    <th style="text-align: center">输入图单价（元/张）</th>
    <th style="text-align: center">输出图单价（元/张）</th>
  </tr>
  <tr>
    <td>5.0 Pro</td>
    <td style="text-align: center">首张免费，第 2 张起 0.02</td>
    <td style="text-align: center">单图生成：1.5K 及以下 0.30，1.5K 以上 0.60<br>图层拆分：1.5K 及以下 0.15，1.5K 以上 0.30</td>
  </tr>
  <tr>
    <td>5.0 / 5.0 Lite</td>
...
<table align="center">
  ...
  <tr>
    ...
    <td>当前生效的工作区根：客户端授权的 MCP Roots，未声明时回退环境配置的工作目录。为参数化资源，部分客户端的资源列表不直接展示，按 URI 读取即可。</td>
  </tr>
  <tr>
    <td><code>seedream://server/info</code></td>
    <td>服务器名称、版本与当前生效配置摘要。</td>
  </tr>
  <tr>
